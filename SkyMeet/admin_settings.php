...
// IMPORTANT: Get full user data including password for password change functionality
// Instead of using getCurrentUser() which might not include password, query directly
...
// Check if meetings table exists and get total meetings count
...
if ($meetings_table_exists) {
    ...
    if ($total_result) {
        ...
        $total_meetings = $total_data['total'] ?? 0;
    }
}
...
// Get team members count (for stats)
    ...
    elseif (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($check_result->num_rows > 0) {
            ...
            if ($check_email_result->num_rows > 0) {
                ...
                $update_stmt = $conn->prepare($update_sql);
                $update_stmt->bind_param("ssi", $new_username, $email, $user_id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        // Check if password field exists in user array
        if (!isset($user['password'])) {
            // Refresh user data to get password
        ...
        if (isset($user['password']) && verifyPassword($current_password, $user['password'])) {
...
// Check if password is secure (bcrypt) - with null check
...
<head>
    ...
    <title>Admin Settings - SkyMeet</title>
    ...
    <style>
        ...
        * {
        ...
        /* Sidebar - Light theme (exactly matching admin_schedule.php) */
        .sidebar {
            background: white;
            position: sticky;
            top: 0;
...
<body>
    ...
    <div class="dashboard-container">
        <!-- Sidebar - Exactly matching admin_schedule.php -->
        <div class="sidebar">
            <div class="logo">
            ...
            <nav class="nav-menu">
                ...
                <a href="admin_meetings.php" class="nav-item">
                    ...
                    <?php if ($total_meetings > 0): ?>
                        <span class="nav-badge"><?php echo $total_meetings; ?></span>
                    <?php endif; ?>
                </a>
        ...
        <div class="main-content">
            ...
            <!-- Settings Navigation Tabs - Only Profile and Password -->
            ...
            <div id="profile-tab" class="settings-content <?php echo $active_tab === 'profile' ? 'active' : ''; ?>">
                <div class="settings-card">
                    ...
                    <form method="POST" action="?tab=profile" class="settings-form" id="profileForm">
                        ...
                        <div class="form-group">
                            <label for="email">Email Address <span style="color: #666; font-weight: normal;">(max 40 characters)</span></label>
            ...
            <div id="password-tab" class="settings-content <?php echo $active_tab === 'password' ? 'active' : ''; ?>">
                <div class="settings-card">
                    ...
                    <?php if (!$is_password_secure && isset($user['password'])): ?>
                    ...
                    <form method="POST" action="?tab=password" class="settings-form" id="passwordForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="new_password" name="new_password" 
                                   ...
                                   maxlength="15" minlength="6" oninput="removeSpaces(this)">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="confirm_password" name="confirm_password" 
                                   ...
                                   maxlength="15" oninput="removeSpaces(this)">
    ...
    <script>
        ...
        function removeSpaces(input) {
            if (input.value.includes(' ')) {
                ...
                // Show warning
                let warningMsg = input.parentNode.querySelector('.space-warning');
                if (!warningMsg) {
                    warningMsg = document.createElement('div');
                    warningMsg.className = 'space-warning';
                    warningMsg.innerHTML = '<i class="fas fa-exclamation-circle"></i> Spaces are not allowed and have been removed';
        ...
        function preventSpace(event) {
            if (event.key === ' ') {
                ...
                if (!warningMsg) {
                    warningMsg = document.createElement('div');
                    warningMsg.className = 'space-warning';
                    warningMsg.innerHTML = '<i class="fas fa-exclamation-circle"></i> Spaces are not allowed';
                    input.parentNode.appendChild(warningMsg);
                }
        ...
        // Check password strength - with space prevention
        function checkPasswordStrength() {
            ...
            if (/\s/.test(password)) {
                ...
                document.getElementById('new_password').value = noSpaces;
                
                // Show warning
                strengthDiv.innerHTML = '<span class="strength-weak"><i class="fas fa-times-circle"></i> Spaces are not allowed and have been removed</span>';
                
                // Recursively call with cleaned password
                setTimeout(() => checkPasswordStrength(), 10);
                return;
            }
        ...
        // Check password match - with space prevention
        function checkPasswordMatch() {
            ...
            if (/\s/.test(confirmPassword)) {
                ...
                const noSpaces = confirmPassword.replace(/\s/g, '');
                document.getElementById('confirm_password').value = noSpaces;
                
                // Show warning
                matchDiv.innerHTML = '<span style="color: #f44336;"><i class="fas fa-times-circle"></i> Spaces are not allowed and have been removed</span>';
            ...
            if (newPassword === confirmPassword) {
                ...
                if (submitBtn && newPassword.length >= 6 && newPassword.length <= 15) {
